...
export default function TryOnContent({ user, paymentStatus }: TryOnContentProps) {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-cream)] dark:bg-[#0F0E0D] relative overflow-clip noise-overlay">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pt-24 pb-16">
        ...
        {/* ── AI Result Display ── */}
        {resultImage && (
          <div className="max-w-4xl mx-auto mt-10 animate-scale-in">
            {/* Section header */}
            ...
            {/* Hero result image — centered */}
            <div className="max-w-lg mx-auto">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-[var(--color-charcoal)]/15 ring-1 ring-[var(--color-stone-light)]/10">
                <img
                ...
                <div className="absolute top-4 right-4">
                  <div className="px-3 py-1.5 rounded-full bg-white/20 backdrop-blur-md border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
        ...
        {/* Footer */}
        <footer className="mt-12 text-center animate-on-load animate-fade-up delay-600">
